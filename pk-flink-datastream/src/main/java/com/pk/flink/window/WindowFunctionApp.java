    ...
    public static void test03(StreamExecutionEnvironment env) {
        env.socketTextStream("localhost", 9527)
                ...
                .process(new ProcessAllWindowFunction<Integer, Integer, GlobalWindow>() {
                    @Override
                    public void process(ProcessAllWindowFunction<Integer, Integer, GlobalWindow>.Context context, Iterable<Integer> values, Collector<Integer> out) throws Exception {
